 ...
 */
class getAcceptationsCGVRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AcceptationsCGVRepository' shared autowired service.
     *
     * @return \App\Repository\AcceptationsCGVRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AcceptationsCGVRepository.php';

        return $container->privates['App\\Repository\\AcceptationsCGVRepository'] = new \App\Repository\AcceptationsCGVRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
