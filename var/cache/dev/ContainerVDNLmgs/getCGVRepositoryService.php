 ...
 */
class getCGVRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CGVRepository' shared autowired service.
     *
     * @return \App\Repository\CGVRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CGVRepository.php';

        return $container->privates['App\\Repository\\CGVRepository'] = new \App\Repository\CGVRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
