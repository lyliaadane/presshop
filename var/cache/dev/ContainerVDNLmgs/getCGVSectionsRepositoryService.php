 ...
 */
class getCGVSectionsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CGVSectionsRepository' shared autowired service.
     *
     * @return \App\Repository\CGVSectionsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CGVSectionsRepository.php';

        return $container->privates['App\\Repository\\CGVSectionsRepository'] = new \App\Repository\CGVSectionsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
