...
class __TwigTemplate_6a36921e7579eace69d9381ac5830a0c extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <h1>Détail de la catégorie</h1>
    ...
    <table class=\"table\">
        ...
        <tr>
            ...
            <td>";
        // line 15
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 15, $this->source); })()), "nom", [], "any", false, false, false, 15), "html", null, true);
        yield "</td>
        </tr>
        <tr>
            <th>Description</th>
            <td>";
        // line 19
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 19, $this->source); })()), "description", [], "any", false, false, false, 19), "html", null, true);
        yield "</td>
        </tr>
    </table>
    ...
    <form method=\"post\" action=\"";
        // line 26
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("categorie_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 26, $this->source); })()), "id", [], "any", false, false, false, 26)]), "html", null, true);
        yield "\" onsubmit=\"return confirm('Êtes-vous sûr ?');\" class=\"d-inline\">
...
";
    ...
    {
        return array (  141 => 27,  137 => 26,  132 => 24,  128 => 23,  121 => 19,  114 => 15,  107 => 11,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <a href=\"{{ path('category_index') }}\" class=\"btn btn-secondary\">Retour à la liste</a>

    <form method=\"post\" action=\"{{ path('categorie_delete', {'id': categorie.id}) }}\" onsubmit=\"return confirm('Êtes-vous sûr ?');\" class=\"d-inline\">
        <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ categorie.id) }}\">
        <button class=\"btn btn-danger\">Supprimer</button>
    </form>
{% endblock %}
", "categorie/show.html.twig", "C:\\Users\\Utilisateur\\Documents\\GitHub\\2024_M2_PRO-03_GR12\\templates\\categorie\\show.html.twig");
    }
}
