...
class __TwigTemplate_62255c42dd2f662f5f555f867a47720c extends Template
{
    ...
    ";
        // line 8
        yield Twig\Extension\CoreExtension::include($this->env, $context, "categorie/_form.html.twig", ["button_label" => "Créer"]);
        yield "
...
{% block body %}
    ...
    {{ include('categorie/_form.html.twig', {'button_label': 'Créer'}) }}

    <a href=\"{{ path('category_index') }}\" class=\"btn btn-secondary mt-3\">Retour à la liste</a>
{% endblock %}
", "categorie/new.html.twig", "C:\\Users\\Utilisateur\\Documents\\GitHub\\2024_M2_PRO-03_GR12\\templates\\categorie\\new.html.twig");
    }
}
