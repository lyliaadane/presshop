...
class __TwigTemplate_fe940b5d955bf4dfd16895cc2a430ad3 extends Template
{
    ...
    ";
        // line 8
        yield Twig\Extension\CoreExtension::include($this->env, $context, "categories/_form.html.twig", ["button_label" => "Mettre à jour"]);
        yield "
...
{% block body %}
    ...
    {{ include('categories/_form.html.twig', {'button_label': 'Mettre à jour'}) }}

    <a href=\"{{ path('categories_index') }}\" class=\"btn btn-secondary mt-3\">Retour à la liste</a>
{% endblock %}
", "categorie/edit.html.twig", "C:\\Users\\Utilisateur\\Documents\\GitHub\\2024_M2_PRO-03_GR12\\templates\\categorie\\edit.html.twig");
    }
}
