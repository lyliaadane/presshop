 ...
 */
class getCommandesProduitsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommandesProduitsRepository' shared autowired service.
     *
     * @return \App\Repository\CommandesProduitsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommandesProduitsRepository.php';

        return $container->privates['App\\Repository\\CommandesProduitsRepository'] = new \App\Repository\CommandesProduitsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
